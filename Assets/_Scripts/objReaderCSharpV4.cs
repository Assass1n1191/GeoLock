...
public class objReaderCSharpV4 : MonoBehaviour {
	...
	public string _textFieldString = "https://dl.dropbox.com/s/4x1f0y796r5pe3n/Crate1.obj";
	public string _textureLink = "https://dl.dropbox.com/s/jmgc954deqhas89/crate_1.jpg";
	public string _meshName = "MeshName";
 ...
 //   {
	...
	//		StartCoroutine(Init("Object for Model"));
	//	}
	//}
